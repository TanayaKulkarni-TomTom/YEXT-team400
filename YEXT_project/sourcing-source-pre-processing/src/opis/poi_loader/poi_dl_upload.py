...
def make_api_request(filename, country, api_url):
    """
    ...
    json_data = {
        ...
        'single_gdf_main_code': SINGLE_GDF_MAIN_CODE,
        'single_gdf_code': SINGLE_GDF_CODE,
        'delimiter': DELIMITER,
    ...
    response = r.post(api_url, json=json_data)
    return response.json()


def poi_dl_upload(files, countries):
    """
